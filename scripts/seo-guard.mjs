...
for (const file of sorted) {
  ...
  // RSK Group / RSK Renewables are a different (UK) company, named on /about/ to tell them apart.
  const bareBrand = /\bRSK\b(?! Solar Energy| SOLAR ENERGY| Group| Renewables)/;
