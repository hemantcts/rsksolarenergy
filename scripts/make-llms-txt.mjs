...
- ${BUSINESS.name} installs on-grid rooftop systems from ${c.sizing.minKwByType['on-grid']} kW, and hybrid and off-grid systems from ${c.sizing.minKwByType['hybrid']} kW. Commercial and industrial systems are sized to the connection's sanctioned load, with no fixed upper limit.
