...
- ${BUSINESS.name} installs on-grid and hybrid rooftop systems from ${c.sizing.minKwByType['on-grid']} kW, and off-grid systems from ${c.sizing.minKwByType['off-grid']} kW.
...
- [PM Surya Ghar subsidy in Punjab](${site}/pm-surya-ghar-subsidy-punjab/): subsidy amounts, eligibility, the application process, and common reasons applications are rejected.
- [On-grid vs off-grid vs hybrid](${site}/on-grid-vs-off-grid-vs-hybrid/)
- [Hybrid solar systems](${site}/hybrid-solar-systems/)
- [Off-grid solar systems](${site}/off-grid-solar-systems/)
- [Solar panels](${site}/solar-panels/)
- [Commercial and industrial solar in Punjab](${site}/commercial-solar-punjab/)
- [Housing society solar](${site}/housing-society-solar/)
- [UTL Solar distributor in Mohali and Punjab](${site}/utl-solar-distributor-punjab/)
${c.sizing.sizePagesKw.map((kw) => `- [${kw} kW solar system price in Punjab](${site}/${kw}kw-solar-system-price-punjab/)`).join('\n')}

## Blog

- [Is solar worth it in Punjab with 300 free units?](${site}/blog/solar-with-300-free-units-punjab/)
- [How to size a home solar system in Punjab](${site}/blog/how-to-size-home-solar-punjab/)
...
console.log(`llms.txt written: ${out.length} bytes`);
