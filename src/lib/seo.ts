...
export function localBusiness() {
  ...
  const sameAs = [BUSINESS.google.mapsUrl, BUSINESS.social.facebook, BUSINESS.social.instagram, BUSINESS.social.youtube, BUSINESS.social.x, BUSINESS.social.linkedin, BUSINESS.justdial.url].filter(
    (u): u is string => !!u,
  );
  return {
